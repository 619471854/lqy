...
public abstract class ParserUtil {
	...
	protected static String encodeUrlParams(String param) {
		return URLEncoder.encode(Util.base64Encode(param));
	}

	protected static String decodeUrlParams(String param) {
		return URLDecoder.decode(Util.base64Decode(param));
	}
