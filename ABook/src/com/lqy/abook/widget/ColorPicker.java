...
public class ColorPicker extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawLine(valueAngleX * innerWheelRadius + centerX, valueAngleY * innerWheelRadius + centerY, valueAngleX * outerWheelRadius + centerX, valueAngleY * outerWheelRadius + centerY,
				valuePointerPaint);
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (d <= colorWheelRadius) {
				...
				if (colorChangelistener != null)
					colorChangelistener.callBack(Color.HSVToColor(colorHSV) + CONSTANT.EMPTY);
	...
	private CallBackListener colorChangelistener;

	public void setColorChangelistener(CallBackListener colorChangelistener) {
