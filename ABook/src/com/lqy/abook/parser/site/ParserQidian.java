...
public class ParserQidian extends ParserBase2 {
	...
	public boolean parserSearch(List<BookEntity> books, String key) {
		return parserSearch(books, config.searchUrl + key, key.split(" "), true);
	}

	@Override
	public boolean parserSearchSite(List<BookEntity> books, String name, String author) {
		return parserSearchSite(books, config.searchUrl + name + " " + author, name, author, true);
	}
